...
function buildTOC(){
    ...
    if(toggle){
        ...
        // matchMedia em vez de innerWidth: não força layout sync (PSI flagga 314ms reflow).
        if(window.matchMedia('(max-width:1023px)').matches){tocAside.setAttribute('data-collapsed','1');toggle.textContent='Mostrar ▼';}
    }
}
buildTOC();
renderSaved();

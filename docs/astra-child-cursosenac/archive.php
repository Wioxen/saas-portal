<?php
/**
 * Astra Child Cursos SENAC Gratuito — archive.php
 */
...
if (is_category()) {
    ...
    $archive_color = csg_cat_color($cat_obj->slug);
...
<?php while (have_posts()): the_post(); $p = get_post(); csg_render_card($p); endwhile; ?>
</div>

...
/**
 * tick_filas_v2_leaodabarra.php — substituto do tick_filas (pausado 2026-05-08).
 *
 ...
 *   2. Filtra origens leaodabarra (pingo:48,51,55-60)
 *   3. Score >= 5.5
...
// Pega candidatas: status=aprovado, score>=5.5, origem leaodabarra, ordenadas por score DESC, data DESC
...
echo "  candidatas aprovado >=5.5 (7d): " . count($candidatas) . "\n";

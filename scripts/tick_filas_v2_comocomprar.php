...
/**
 * tick_filas_v2_comocomprar.php — substituto do tick_filas (pausado 2026-05-08).
 *
 ...
 *   2. Filtra origens comocomprar (pingo:48,51,55-60)
 *   3. Score >= 5.5
...
// Pega candidatas: status=aprovado, score>=5.5, origem comocomprar, ordenadas por score DESC, data DESC
...
// Filtra dedup
// Filtro de nicho: trend deve ter pelo menos 1 keyword de comprar/produto/preço
$keywordsNicho = '/\b(comprar|oferta|desconto|barato|melhor|preç[oa]|amazon|magazine|americanas|mercadolivre|shopee|aliexpress|review|comparativo|review|frete|kit|combo|lan[çc]amento|liquida[çc][aã]o|black\s+friday|cupom|promo[çc][aã]o|recomenda|wi-fi|smartphone|notebook|tv|fogão|geladeira)/iu';

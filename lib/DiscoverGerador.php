...
class DiscoverGerador
{
    ...
    public function gerar(array $trend, string $formato = 'discover'): array
    {
        ...
        if (($cluster['key'] ?? '') === 'esportes') {
            $blocos[] = "\n═══ ESPORTES — IDENTIFIQUE O TIPO DE CONTEÚDO ANTES DE TUDO ═══\n"
                      . "Cluster esportes cobre MUITAS situações distintas. ANTES de escrever,\n"
                      . "identifique qual é o caso e use o ângulo APROPRIADO. NÃO force template\n"
                      . "de uma situação em outra (ex: NÃO incluir 'onde assistir' em mercado da bola).\n\n"
                      . "TIPOS DE CONTEÚDO POSSÍVEIS:\n"
                      . "  A. PRÉ-JOGO de partida específica (ex: 'Palmeiras x Santos hoje às 18h30')\n"
                      . "     → Foco: onde assistir, horário, escalações, contexto da rodada\n"
                      . "  B. PÓS-JOGO / RESULTADO (ex: 'Vitória vence Coritiba por 2x1')\n"
                      . "     → Foco: como foi o jogo, gols, destaques, próximos compromissos\n"
                      . "  C. MERCADO DA BOLA / TRANSFERÊNCIA (ex: 'Raphinha alvo de proposta saudita')\n"
                      . "     → Foco: valores, contratos, contexto de carreira, posição do clube\n"
                      . "     → ❌ NÃO inclua 'onde assistir', 'horário', 'escalação' — irrelevante\n"
                      . "  D. LESÃO / SUSPENSÃO / DESFALQUE (ex: 'Neymar fora por lesão muscular')\n"
                      . "     → Foco: tempo de recuperação, impacto no time, histórico médico\n"
                      . "  E. ANÁLISE TÁTICA / TÉCNICO (ex: 'Esquema de Abel deu certo contra X')\n"
                      . "     → Foco: tática, decisões do treinador, diferencial do esquema\n"
                      . "  F. POLÊMICA / ARBITRAGEM (ex: 'STJD julga caso')\n"
                      . "     → Foco: o que aconteceu, posição das partes, possível punição\n"
                      . "  G. F1 / MMA / NBA / OUTROS ESPORTES (ex: 'Norris pole position GP Miami')\n"
                      . "     → Foco específico da modalidade. Cada esporte tem seu vocabulário.\n"
                      . "  H. TABELA / CLASSIFICAÇÃO / CALENDÁRIO (ex: 'Tabela do Brasileirão')\n"
                      . "     → Foco: posições atuais, próximos jogos, cenário G6/Z4\n\n"
                      . "REGRA: leia o termo + as fontes. Identifique qual tipo é. Use os elementos\n"
                      . "RELEVANTES daquele tipo. Se uma matéria é sobre transferência (tipo C),\n"
                      . "incluir 'onde assistir' é forçar contexto fora — penaliza qualidade.\n"
                      . "═══ FIM TIPOS DE CONTEÚDO ═══\n";
            ...
            $blocos[] = "\n═══ ESPORTES — ESTRUTURA DO ARTIGO (universal) ═══\n"
                      ...
                      . "  ✓ Use H2/H3. Subseções H3 dentro de H2.\n"
                      . "  ✓ Primeira frase é o FATO PRINCIPAL específico do tipo de conteúdo:\n"
                      . "    - Tipo A (pré-jogo):  'X e Y se enfrentam neste sábado às 18h30 em [local].'\n"
                      . "    - Tipo C (mercado):   'Raphinha está no radar de clube saudita por € 100mi.'\n"
                      . "    - Tipo D (lesão):     'Neymar sentiu lesão muscular e ficará fora por X semanas.'\n"
                      . "    - Tipo G (F1):        'Norris conquistou pole position do GP de Miami neste sábado.'\n"
                      . "  ✗ NUNCA: 'Buscas por X saltaram esta semana...' (meta-narração genérica)\n"
                      . "  ✗ NUNCA: incluir bloco de urgência 'AO VIVO HOJE às XX' em conteúdo\n"
                      . "    que NÃO seja pré-jogo (tipo A). Em mercado/lesão/polêmica = irrelevante.\n"
                      . "  ✓ SE tipo A (pré-jogo confirmado): pode incluir bloco de urgência logo após\n"
                      . "    o lead com horário, transmissão e gancho.\n"
                      . "═══ FIM ESTRUTURA ═══\n";

            $blocos[] = "\n═══ ESPORTES — ENTIDADES (universal) ═══\n"
                      . "Repita NOME COMPLETO 1-2x ao longo do artigo (NER):\n"
                      ...
                      . "  ✓ Jogador com posição na 1ª menção: 'Endrick (atacante)'\n\n"
                      . "Palavras-chave secundárias só onde fizer SENTIDO no contexto:\n"
                      . "  ✓ 'ao vivo' / 'transmissão' — APENAS em conteúdo sobre partidas (tipo A/B)\n"
                      . "  ✓ Para tipo C (mercado): 'proposta', 'salário', 'multa', 'agente', 'janela'\n"
                      . "  ✓ Para tipo D (lesão): 'recuperação', 'tempo afastado', 'departamento médico'\n"
                      . "  ✓ Para tipo G (F1): 'pole', 'volta mais rápida', 'pit stop', 'safety car'\n"
                      . "Cada keyword deve fazer sentido NATURAL no contexto. Sem stuffing.\n"
                      . "═══ FIM ENTIDADES ═══\n";
